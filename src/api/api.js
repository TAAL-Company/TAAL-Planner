...
export const getingTask_Performance = async (dateFilter, studentId, taskId, routeId, siteId) => {
  let taskssperformance;

  await get(baseUrl + '/tasks-performance/' + dateFilter + studentId + taskId + routeId + siteId).then((res) => {
    taskssperformance = res.data;
  });
  console.log('res /tasks-performance: ', taskssperformance);
